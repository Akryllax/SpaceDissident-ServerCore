...
public:
  ...
  Matrix3 getInverse() const
  {
    ...
    Matrix3 tempMatrix((m[1][1] * m[2][2] - m[2][1] * m[1][2]),
  ...
  {
    return Matrix3(m[0][0] + matrix2.m[0][0],
                   m[0][1] + matrix2.m[0][1],
                   m[0][2] + matrix2.m[0][2],
                   m[1][0] + matrix2.m[1][0],
                   m[1][1] + matrix2.m[1][1],
  ...
  {
    return Matrix3(
        m[0][0] * matrix2.m[0][0] + m[0][1] * matrix2.m[1][0] + m[0][2] * matrix2.m[2][0],
